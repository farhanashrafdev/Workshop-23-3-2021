...
probePage.open(inputFile, function(status) {
  ...
  var config = probePage.evaluate(function() { return Reveal.getConfig(); });
  ...
  if (config) {
    ...
    printPage.onCallback = function(data) {
      // For some reason we need to "jump the queue" for syntax highlighting to
      // work. See: http://stackoverflow.com/a/3580132/129269
      setTimeout(function() {
